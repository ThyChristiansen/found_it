...
class BoxList extends Component {
  ...
  handleOnClickAddNewBox = () => {
    ...
    //this.setState({ addedBoxTransaction: true });
    dispatch({
      type: "ADD_BOX",
      payload: {
        roomId: match.params.id,
  ...
  render() {
    ...
    if (this.props.reduxState.boxes.length === 0) {
      addNewBox = (
        <button
          onClick={this.handleOnClickAddFirstBoxInRoom}
          className="add_new_box_btn"
        >
          Add new box
        </button>
      );
      ...
      addNewBox = (
        <button
          onClick={this.handleOnClickAddNewBox}
          className="add_new_box_btn"
        >
          Add new box
        </button>
    ...
    return (
      <div>
        ...
        <div className="box_list_page">
          ...
          <p className="box_quantity">
            Box quantity: {this.props.reduxState.boxes.length}
          </p>
                  ...
                  <div key={box.id}>
                    <Grid item>
                      <Grid className={classes.margin}>
                        {box.id ===
                        this.props.reduxState.boxes[
                          this.props.reduxState.boxes.length - 1
                        ].id ? (
                          <>
                            <Zoom in={true}>
                              <div>
