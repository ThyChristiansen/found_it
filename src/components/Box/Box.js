...
class Box extends Component {
  handleClick = () => {
    ...
    this.props.history.push(
      `/box-detail/${this.props.box.room_id}/${this.props.box.id}`
    );
  };
  ...
  render() {
    ...
    if (this.props.box.room_name === "Storage") {
      boxName = (
        <p className="box_name_in_box_list">A{this.props.box.box_name}</p>
      );
    }
    if (this.props.box.room_name === "Basement") {
      boxName = (
        <p className="box_name_in_box_list">B{this.props.box.box_name}</p>
      );
    }
    if (this.props.box.room_name === "Garage") {
      boxName = (
        <p className="box_name_in_box_list">C{this.props.box.box_name}</p>
      );
    }
